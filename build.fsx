...
Target.create "BuildLiteDBFSharp" (fun _ ->
    let sharedPath = Path.getFullName "./paket-files/github.com/gretmn102/LiteDB.FSharp/LiteDB.FSharp"
    dotnet "build -c Release" sharedPath
)
